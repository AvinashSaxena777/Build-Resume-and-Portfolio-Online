...
define('DB_SERVER', 'localhost');
   ...
   $db = mysqli_connect(DB_SERVER,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
    ...
    if(isset($_POST['update_ed'])){
        ...
        $id = $_SESSION['id'];
        $sql = "INSERT INTO education (id, ed_level, ed_detail, ed_start, ed_last) VALUES ('$id', '$ed_level', '$ed_detail', '$ed_start', '$ed_last')";
                                        ...
                                        <div class="card-body">
                                            <form action="" method="post" style="padding: 20px; text-align: center">
                                                 <div class="form-group" style="padding: 10px">
                                                        ...
                                                        <textarea class="form-control" name="ed_detail" id="exampleFormControlTextarea1" rows="3" placeholder="Institution Name, Grade, Branch etc"></textarea>
                                                      </div>
