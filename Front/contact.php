  ...
  <body>
    ...
    <section class="background-gray-lightest">
      <div class="container">
        ...
        <p class="lead">We focus on providing best experience to our users. We are available 24*7 for any kind of enquiry, feedback, response, advices etc. We will love to hear from you.</p>
      </div>
    </section>
    <section>  
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="box-simple">
              ...
              <p>117/2 Vallabh Nagar<br>Indore, Madhya Pradesh <strong>India</strong></p>
            </div>
            <div class="box-simple">
              <div class="icon"><i class="pe-7s-phone"></i></div>
              <h4 class="heading margin-bottom">Call center</h4>
              <p class="text-muted">This number is avaliable 24*7</p>
              <p><strong>+91 786 990 3489</strong></p>
            </div>
            <div class="box-simple">
              ...
              <ul>
                <li><strong><a href="mailto:">ansh.shivhare07@gmail.com</a></strong></li>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-6">
              ...
              <ul>
                <li><a href="category.html">Resume Help</a></li>
                <li><a href="category.html">Portfolio Help<a></li>
                <li><a href="category.html">Interface help</a></li>
