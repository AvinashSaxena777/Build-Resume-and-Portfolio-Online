  ...
  <img src="img/Screenshot%20(96).png" alt="Avatar" class="image">
            ...
            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                ...
                <form action="PortfolioTemplates/ceevee/index.php" method='post'><input type="submit" class="btn btn-primary" name='generatePortfolio' value="Generate Portfolio"></form>
                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                          <img class="d-block w-100" src="img/Screenshot%20(97).png" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="img/Screenshot%20(98).png" alt="Third slide">
                        </div>
                      </div>
